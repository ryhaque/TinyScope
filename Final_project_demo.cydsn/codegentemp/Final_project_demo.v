// ======================================================================
// Final_project_demo.v generated from TopDesign.cysch
// 12/09/2020 at 00:21
...
module Scan_ADC_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("c0422d46-d86b-49ad-beb0-e9a0393207f9/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module SCB_UART_PDL_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("749ae08e-2b02-46cf-9d7a-cea007429506/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("749ae08e-2b02-46cf-9d7a-cea007429506/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("749ae08e-2b02-46cf-9d7a-cea007429506/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module top ;
	...
	wire [0:0] tmpFB_0__ch2_net;
	wire [0:0] tmpIO_0__ch2_net;
	electrical [0:0] tmpSIOVREF__ch2_net;

	cy_mxs40_gpio_v1_0
		#(.id("bca8afa4-fe95-41ef-b5af-2bb6ef65275c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		ch2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ch2_net[0:0]}),
		  .analog({Net_425}),
		  .io({tmpIO_0__ch2_net[0:0]}),
		  .siovref(tmpSIOVREF__ch2_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("34c8cd96-cfe2-4fe2-9d84-f7095ecd10d2"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("1d4199e8-9a86-447f-893b-bec7f2225b26"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
