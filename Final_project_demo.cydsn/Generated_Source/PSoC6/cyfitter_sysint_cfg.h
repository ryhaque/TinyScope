...
/* ARM CM4 */
    ...
    #define UART_1_INT__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t UART_1_INT_cfg;

    #define DMA_ISR__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t DMA_ISR_cfg;
